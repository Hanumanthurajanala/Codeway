...
class GUI():
    def __init__(self, master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='green', bg='#FF8000',
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#FF8000', fg='green')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#FF8000', fg='green')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#FF8000', fg='green')
